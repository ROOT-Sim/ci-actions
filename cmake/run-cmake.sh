...
Windows* | MINGW* | MSYS*)
  ...
  cmake -G "Visual Studio 17 2022" -A x64 -T ClangCL -DCMAKE_C_COMPILER="$INPUT_CC" -DCMAKE_CXX_COMPILER="$INPUT_CXX" -DCMAKE_BUILD_TYPE="$INPUT_BUILD_TYPE" -DCMAKE_C_FLAGS="$INPUT_CFLAGS" -DCMAKE_CXX_FLAGS="$INPUT_CXXFLAGS" "${args[@]}" "$INPUT_SOURCE_DIR"
  ;;
*)
